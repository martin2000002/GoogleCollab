...
def run_tsp_all():
    ...
    _run_tsp_with_all(
        ...
        pso_params=dict(swarm_size=4000, max_epochs=1500, alpha1=1, alpha2=0.9, inertia=0.88, vmax_frac=0.7),
        hybrid_params=dict(
    ...
    _run_tsp_with_all(
        ...
        pso_params=dict(swarm_size=8000, max_epochs=1500, alpha1=1, alpha2=0.9, inertia=0.88, vmax_frac=0.65),
        hybrid_params=dict(
    ...
    _run_tsp_with_all(
        ...
        pso_params=dict(swarm_size=4000, max_epochs=2000, alpha1=1, alpha2=0.9, inertia=0.90, vmax_frac=0.7),
        hybrid_params=dict(
    ...
    _run_tsp_with_all(
        ...
        pso_params=dict(swarm_size=8000, max_epochs=2000, alpha1=1, alpha2=0.9, inertia=0.90, vmax_frac=0.65),
        hybrid_params=dict(
            ga_population_size=100, ga_elite_ratio=0.2, ga_mutation_prob=0.3, ga_max_generations=100, ga_k=4,
