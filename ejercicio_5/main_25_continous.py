...
def run_tsp_all():
    ...
    _run_tsp_with_all(
        ...
        pso_params=dict(swarm_size=1000, max_epochs=1000, alpha1=1, alpha2=0.5, inertia=0.5, vmax_frac=1),
        hybrid_params=dict(
    ...
    _run_tsp_with_all(
        ...
        pso_params=dict(swarm_size=1000, max_epochs=1000, alpha1=2.3, alpha2=0.5, inertia=0.4, vmax_frac=1),
        hybrid_params=dict(
